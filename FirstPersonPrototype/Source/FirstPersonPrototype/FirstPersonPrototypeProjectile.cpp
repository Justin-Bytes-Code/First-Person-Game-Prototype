...
AFirstPersonPrototypeProjectile::AFirstPersonPrototypeProjectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AFirstPersonPrototypeProjectile::OnHit);		// set up a notification for when this component hits something blocking
