...
{
	//Create a new local static mesh variable. 
	UStaticMesh* mesh = baseMesh->GetStaticMesh();
	if (mesh)
	{
		//Whatever basemesh they are pulling from Vertices, Triangles, Normals, UV0, Tangents from a static mesh to generate a procedule mesh from it
